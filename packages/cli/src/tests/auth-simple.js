...
import { WalletAuth, PeerIdentityManager, ConsensusVerification, BanListChecker, } from '@accord/core';
async function main() {
    console.clear();
    console.log('╔════════════════════════════════════════════════════════════╗');
    ...
    const ownerAccount = privateKeyToAccount('0x' + '1'.repeat(64));
    const peer1Account = privateKeyToAccount('0x' + '2'.repeat(64));
    const peer2Account = privateKeyToAccount('0x' + '3'.repeat(64));
    ...
    const mockBanList = {
        ...
        bans: [
            {
                address: '0xBADbadBADbadBADbadBADbadBADbadBADbadBADa',
                reason: 'Spamming',
    ...
    banChecker.banList = mockBanList;
    banChecker.lastRefresh = Date.now();
    console.log('✅ Loaded mock ban list:');
    console.log(`   Total bans: ${mockBanList.bans.length}\n`);
    const testAddresses = [
        peer1Account.address,
        '0xBADbadBADbadBADbadBADbadBADbadBADbadBADa',
